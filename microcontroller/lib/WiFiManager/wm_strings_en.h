...
"document.getElementById('hc-name').textContent=document.getElementById('s').value;"
"var t=document.getElementById('hc-title');if(t)t.style.display='none';"
"document.querySelectorAll('.wl').forEach(function(e){e.style.display='none'});"
"document.getElementById('p').style.display='block';"
"document.getElementById('p').disabled=false;"
"document.getElementById('hc-btn').style.display='block';"
"document.getElementById('p').focus();}"
"</script>";

const char HTTP_HEAD_END[]         PROGMEM = "</head><body class='{c}'><div class='wrap'><h2 id='hc-title'>Choose WiFi</h2>"; // {c} = _bodyclass
...
const char HTTP_ROOT_MAIN[]        PROGMEM = "<script>location.replace('/wifi');</script>";
...
const char HTTP_ITEM[]             PROGMEM = "<div class='wl'><a href='#p' onclick='c(this)' data-ssid='{V}'>{v}</a></div>";
// const char HTTP_ITEM[]            PROGMEM = "<div><a href='#p' onclick='c(this)'>{v}</a> {R} {r}% {q} {e}</div>"; // test all tokens

const char HTTP_FORM_START[]       PROGMEM = "<form method='POST' action='{v}'>";
const char HTTP_FORM_WIFI[]        PROGMEM = "<input id='s' name='s' type='hidden'><div id='hc-name'></div><input id='p' name='p' maxlength='64' type='text' placeholder='Password' style='display:none' autocomplete='current-password'>";
const char HTTP_FORM_WIFI_END[]    PROGMEM = "";
const char HTTP_FORM_STATIC_HEAD[] PROGMEM = "<hr><br/>";
const char HTTP_FORM_END[]         PROGMEM = "<button id='hc-btn' type='submit' style='display:none'>Connect</button></form>";
...
"body{background:#111;color:#eee;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;padding:16px}"
"h1,h3,hr,br{display:none}"
"h2{font-size:20px;font-weight:bold;padding:4px 0 14px}"
".wrap{width:100%;max-width:100%}"
".wl a{display:block;background:#1e1e1e;border:1px solid #333;border-radius:10px;padding:14px 16px;margin:6px 0;text-decoration:none;color:#eee;font-size:16px;cursor:pointer}"
".wl a:active{background:#2a2a2a}"
"#hc-name{font-size:18px;font-weight:bold;padding:4px 0 12px}"
"input[type=password]{width:100%;background:#1e1e1e;color:#eee;border:1px solid #444;border-radius:8px;padding:12px 14px;font-size:16px;margin:6px 0}"
"input[type=password]::placeholder{color:#555}"
"button[type=submit]{width:100%;background:#2196F3;color:#fff;border:none;border-radius:8px;padding:14px;font-size:16px;font-weight:bold;cursor:pointer;margin-top:4px}"
".h{display:none}"
"</style>";
